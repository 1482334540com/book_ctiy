<%@ page import="com.javaweb.bookMall.bean.Order" %><%--jsp标准代码--%>
            ...
            <table  border="1" class=" table table-hover">
                    ...
                    <tr>
                        ...
                        <td>${status}
                            ...
                            <c:if test="${order.status == 0}">
                                <a  href="/book_ctiy/orderServlet?action=delivery&orderId=${order.orderId}" class="btn btn-success " role="button"  style="margin-left: 15px;">发货</a>
                            </c:if>
